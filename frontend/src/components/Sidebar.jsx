...
import {SettingsOutlined, ChevronLeft, ChevronLeftOutlined, HomeOutlined,
     ShoppingCartOutlined, Groups2Outlined, ReceiptLongOutlined, PublicOutlined, 
     PointOfSaleOutlined, TodayOutlined, CalenderOutlined, AdminPanelSettingsOutlined, 
     TrendingUpOutlined, PieChartOutlined, CalendarMonthOutlined, ChevronRightOutlined} from "@mui/icons-material";
            ...
            <Box m="1.5rem 2rem 2rem 3rem">
                <FlexBetween color={theme.palette.secondary.main}>
                    <Box display="flex" alignItems="center" gap="0.5rem">
                        <Typography variant="h4" fontWeight="bold">MTECH</Typography>
                    </Box>
                    {!props.isNonMobile &&
